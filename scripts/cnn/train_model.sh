...
for seed in "${seeds[@]}"; do
  ...
  python ../train.py --lr $lr --epochs 3000 --batch_size $batch_size --model cnn --device cuda:$device --method $method --seed $seed --no_wandb --save --save-dir ./best_results_3000/ --run_to_end
done
